...
public class SubnetEnrichers {
    ...
    public static EnricherSpec<?> uriTransformingEnricher(SubnetTier subnetTier, AttributeSensor<String> original, AttributeSensor<String> target) {
        return EnricherSpec.create(UriTransformerEnricher.class)
                .configure(UriTransformerEnricher.SUBNET_TIER, subnetTier)
                .configure(UriTransformerEnricher.SOURCE_SENSOR, original)
                .configure(UriTransformerEnricher.TARGET_SENSOR, target);
    }
    ...
    public static EnricherSpec<?> uriTransformingEnricher(SubnetTier subnetTier, EntityAndAttribute<String> original, AttributeSensor<String> target) {
        return EnricherSpec.create(UriTransformerEnricher.class)
                .configure(UriTransformerEnricher.SUBNET_TIER, subnetTier)
                .configure(UriTransformerEnricher.SOURCE_SENSOR, original.getAttribute())
                .configure(UriTransformerEnricher.PRODUCER, original.getEntity())
                .configure(UriTransformerEnricher.TARGET_SENSOR, target);
    }
    ...
    public static class UriTransformerEnricher extends Transformer<Object, String> {
    ...
    public static class HostAndPortTransformingEnricher extends Transformer<Object, String> {
        ...
        public void init() {
            ...
            setConfig(TRANSFORMATION_FROM_EVENT, new Function<SensorEvent<Integer>,String>() {
                    @Override public String apply(SensorEvent<Integer> event) {
